                ...
                <div class="card shadow-sm border">
                    <div class="card-body">
                        <div class="col-md-12">
                            ...
                            <h4 class="mt-2">Hotel Kuta</h4>
                            <div class="d-flex justify-content-between">
                                <h6>Bojonggede <br> Kabupaten Bogor, Jawa Barat 16820</h6>
                            ...
                            <table>
                                ...
                                <tr>
                                    <td>Nama {{ $pay->Customer->name }}</td>
                                </tr>
                                <tr>
                                    <td>Reservasi Kamar {{ $transaction->Room->Type->name }} {{ $transaction->Room->no}} </td>
                                </tr>
                                <tr>
                                    <th>Price/day IDR {{ number_format($transaction->Room->price) }}</th>
                                </tr>
                            </table>
                            <table class="mt-3">
                                ...
                                <tr>
                                    <td>Check in
                                        {{ Carbon\Carbon::parse($transaction->check_in)->isoformat('D MMM Y, h.mm') }}
                                    </td>
                                </tr>
                                <tr>
                                    <td>Check out
                                        {{ Carbon\Carbon::parse($transaction->check_out)->isoFormat('D MMM Y, h.mm') }}
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <th>Total Price IDR {{ number_format($transaction->getTotalPrice()) }}</th>
                                </tr>
