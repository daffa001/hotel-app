                ...
                <table class="table table-striped table-bordered table-responsive" id="myTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            @php
                            $matchedTransaction = $transaction->where('payments_id', $p->id);
                            @endphp

                            @if ($matchedTransaction)
                            @php
                            $jumlah = $matchedTransaction->count();
                            @endphp
                            <td class="text-center">{{ $jumlah }}</td>

                            <td class="text-center">
                                {!! $matchedTransaction->pluck('Room.Type.name')->filter()->unique()->implode('<br>') !!}
                            </td>
                            @else
                            ...
                            <td class="text-center">
                                @if ($p->status == 'Denied' and $p->image == null)
