        ...
        <div class="container">
            <div class="card">
                <div class="card-header">
                    <h4>Edit data Kamar {{$typeid->name}} </h4>
                </div>
                <div class="card-body">
                    <form action="/dashboard/data/room/{{ $p->id }}/update" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-2">
                                ...
                                <input type="text" name="id" class="form-control" id="id" readonly value="{{ $count+1 }}">
                            </div>
                            <div class="col-md-2">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" value="{{$typeid->name}}" class="form-control" id="type_name" name='type_name' required>
