            ...
            <div class="d-flex">
              <h5> #{{$p->invoice}}
                ...
                <a href="" style=" pointer-events: none;
                                cursor: default;" onclick="window.print()"><i class="fas fa-print" style="margin-top: 5px"></i></a>
              </h5> &nbsp;
              @else
              ...
              <div class="col-md-12">
                <header class="clearfix">
                  ...
                  <div id="company" class="clearfix">
                    <div>Admin Hotel Kuta</div>
                    <div>Bojonggede<br /> Jawa Barat</div>
                    <div>+62 85773674231</div>
                    <div><a>prtmandri3@gmail.com</a></div>
                  </div>
                  <div id="project">

                    <div><span>CLIENT</span> {{$p->customer->name}}</div>
                    <div><span>TELPHONE</span> {{$p->customer->telp}}</div>
                    <div><span>EMAIL</span> <a> {{$p->customer->user->email }}</a></div>
                  ...
                  <table class="table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="qty text-center">{{number_format($t->room->price)}}</td>
                        <td class="total text-center">{{ number_format($t->price) }}</td>
                      </tr>
                      @endforeach
