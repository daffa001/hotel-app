<nav class="navbar navbar-expand-lg px-lg-3 py-lg-2 shadow sticky-top">
    <div class="container">
        <a class="navbar-brand me-5 fw-bold fs-3 h-font" href="/"><span class="h5 fw-bold fs-3"> Hotel Kuta </span>
        </a>
        ...
        <div class="offcanvas offcanvas-end w-50" tabindex="-1" id="offcanvasNavbar"
            ...
            <div class="offcanvas-header">
                <h5 class="offcanvas-title" id="offcanvasNavbarLabel">Hotel Kuta</h5>
            ...
            <div class="offcanvas-body">
                <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                    ...
                    <li class="nav-item">
                        <a class="nav-link me-2 {{ Request::is('facilities*') ? 'active' : '' }}"
                    ...
                    @guest
                        <li class="nav-item">
                            <a class="btn btn-primary ms-2 {{ Request::is('login') ? 'active' : '' }}"
                                href="/login">Login</a>
                        </li>
                    @endguest
                            ...
                            <ul class="dropdown-menu ">
                                @if (auth()->user()->is_admin == 1)
                                    <li><a class="dropdown-item" href="/dashboard">
                                            <i class="bi bi-pc-display" style="font-size:15px"></i>&nbsp; My
                                            Dashboard</a></li>
                                    <li>
                                ...
                                <li><a class="dropdown-item mt-2 mb-2" href="/myaccount">
                                        <i class="bi bi-person-vcard-fill" style="font-size:15px"></i> &nbsp;My
                                        account</a></li>
                                <li>
                                    <hr class="dropdown-divider">
                                </li>
                                <li><a class="dropdown-item mt-2 mb-2" href="/cart">
                                        <i class="bi bi-cart-check-fill" style="font-size:15px"
                                            aria-hidden="true"></i>&nbsp; cart</a></li>
                                <li>
                                    <hr class="dropdown-divider">
                                </li>
                                <li><a class="dropdown-item mt-2 mb-2" href="/history">
                                        <i class="bi bi-file-earmark-text-fill" style="font-size:15px"
