<nav class="navbar navbar-expand-lg px-lg-3 py-lg-2 shadow sticky-top">
    <div class="container">
        <a class="navbar-brand me-5 fw-bold fs-3 h-font" href="/"><span class="h5 fw-bold fs-3"> Hotel Kuta </span> </a>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu ">
                            ...
                            <li><a class="dropdown-item mt-2 mb-2" href="/cart">
                                    <i class="bi bi-cart-check-fill" style="font-size:15px" aria-hidden="true"></i>&nbsp; cart</a></li>
                            <li>
                                <hr class="dropdown-divider">
                            </li>
                            <li><a class="dropdown-item mt-2 mb-2" href="/history">
                                    <i class="bi bi-file-earmark-text-fill" style="font-size:15px" aria-hidden="true"></i>&nbsp; history</a></li>
                            <li>
                                <hr class="dropdown-divider">
                            </li>
                            <li>
