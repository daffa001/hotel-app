...
INSERT INTO `carts` (`id`, `c_id`, `rooms_id`, `check_in`, `check_out`, `price_day`, `price`, `quantity`, `created_at`, `updated_at`) VALUES
(67,	12,	26,	'2025-08-09',	'2025-08-10',	650000.00,	650000.00,	1,	'2025-08-08 19:15:33',	'2025-08-08 19:15:33');
...
(11,	'dada',	NULL,	'?',	NULL,	NULL,	NULL,	'2025-08-04 22:54:18',	'2025-08-04 22:54:18'),
(12,	'andri123',	'123',	'L',	'123',	'2025-08-09',	'123',	'2025-08-08 05:32:51',	'2025-08-08 18:43:30');
...
(19,	'2025_08_08_073825_create_room_stocks_table',	7);
...
(25,	12,	'01INV1l5zQ',	2,	1050000.00,	'Pending',	'bukti-images/etmgBIzA7ygAZIKaAoMG76PaZBKDK5CL6StjeSug.jpg',	'2025-08-08 05:40:28',	'2025-08-08 05:40:28'),
(26,	9,	'01INV2nH2d',	2,	700000.00,	'Pending',	'bukti-images/WWPVjWHgHz7rkzeEoMSAJkPEyH6uoyckIIVXljpw.jpg',	'2025-08-08 06:06:09',	'2025-08-08 06:06:09'),
(27,	12,	'01INV34TN9',	2,	350000.00,	'Pending',	'bukti-images/6tJk1cwHOknXjqDB6fuvtKtTOyWj7NpHGWbhhfIG.jpg',	'2025-08-08 19:07:23',	'2025-08-08 19:07:23'),
(28,	12,	'01INV4RYzf',	2,	350000.00,	'Pending',	'bukti-images/VeOHQKvFRWDpRkTvQOn2A2dj5qZhlt8A0mDSvqxi.jpg',	'2025-08-08 19:12:59',	'2025-08-08 19:12:59'),
(29,	12,	'02INV5Oobc',	2,	1550000.00,	'Pending',	'bukti-images/fzPaYLFokms48q690BuF04uYJF1Shgs9SqU50DIg.jpg',	'2025-08-08 19:14:46',	'2025-08-08 19:14:46');
...
INSERT INTO `rooms` (`id`, `no`, `type_id`, `status_id`, `capacity`, `price`, `stock`, `info`, `created_at`, `updated_at`) VALUES
(21,	'10A',	1,	1,	3,	350000,	8,	'Dirancang untuk pelancong bisnis maupun rekreasi, Kamar Standar kami menawarkan perpaduan sempurna antara kenyamanan dan fungsionalitas. Ruangan yang ditata secara efisien ini menyediakan semua kebutuhan esensial untuk memastikan Anda mendapatkan istirahat yang berkualitas setelah seharian beraktivitas.',	'2025-07-05 09:24:03',	'2025-08-08 01:01:29'),
(24,	'10B',	2,	1,	4,	500000,	0,	'Tingkatkan pengalaman menginap Anda di Kamar Superior kami yang luas dan elegan. Dirancang khusus bagi Anda yang menginginkan kenyamanan lebih, kamar ini menawarkan ruang gerak yang lebih lega serta fasilitas tambahan untuk memanjakan Anda. Dengan jendela yang lebih besar, nikmati pemandangan kota atau taman yang menenangkan langsung dari kamar Anda.',	'2025-07-05 09:32:32',	'2025-07-05 09:32:32'),
(26,	'10C',	3,	1,	6,	650000,	9,	'Nikmati puncak kemewahan dan keanggunan di Kamar Deluxe kami. Sebagai pilihan akomodasi paling premium, kamar ini menawarkan ruang yang sangat luas, desain interior yang megah, dan fasilitas terbaik di kelasnya. Dari jendela panorama, Anda akan disuguhi pemandangan spektakuler kota, laut, atau taman yang tak tertandingi,',	'2025-07-05 09:35:45',	'2025-08-04 22:55:28'),
(28,	'10D',	5,	1,	8,	1200000,	10,	'Ciptakan kenangan indah bersama orang-orang terkasih di Family Suite kami. Didesain secara khusus untuk memenuhi kebutuhan keluarga,menyediakan ruang yang lapang dan nyaman untuk semua anggota keluarga.',	'2025-07-05 20:25:50',	'2025-07-05 20:25:50');
...
DROP TABLE IF EXISTS `room_stocks`;
CREATE TABLE `room_stocks` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `room_stocks_c_id_index` (`c_id`),
  KEY `room_stocks_t_id_index` (`t_id`),
  KEY `room_stocks_r_id_index` (`r_id`),
  CONSTRAINT `room_stocks_c_id_foreign` FOREIGN KEY (`c_id`) REFERENCES `customers` (`id`) ON DELETE CASCADE,
  CONSTRAINT `room_stocks_r_id_foreign` FOREIGN KEY (`r_id`) REFERENCES `rooms` (`id`) ON DELETE CASCADE,
  CONSTRAINT `room_stocks_t_id_foreign` FOREIGN KEY (`t_id`) REFERENCES `transactions` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `transactions` (`id`, `c_id`, `room_id`, `payments_id`, `price`, `quantity`, `check_in`, `check_out`, `status`, `created_at`, `updated_at`) VALUES
(32,	12,	21,	25,	1050000.00,	5,	'2025-08-08',	'2025-08-11',	'Reservation',	'2025-08-08 05:40:28',	'2025-08-08 05:40:28'),
(33,	9,	21,	26,	700000.00,	5,	'2025-08-12',	'2025-08-14',	'Reservation',	'2025-08-08 06:06:09',	'2025-08-08 06:06:09'),
(34,	12,	21,	27,	350000.00,	1,	'2025-08-09',	'2025-08-10',	'Reservation',	'2025-08-08 19:07:23',	'2025-08-08 19:07:23'),
(35,	12,	21,	28,	350000.00,	1,	'2025-08-09',	'2025-08-10',	'Reservation',	'2025-08-08 19:12:59',	'2025-08-08 19:12:59'),
(36,	12,	28,	29,	1200000.00,	1,	'2025-08-09',	'2025-08-10',	'Reservation',	'2025-08-08 19:14:46',	'2025-08-08 19:14:46'),
(37,	12,	21,	29,	350000.00,	1,	'2025-08-09',	'2025-08-10',	'Reservation',	'2025-08-08 19:14:46',	'2025-08-08 19:14:46');
...
(9,	'user-images/N351Hwe0zFETPMBR44A8N3XAaV598KtOHx2TnHnc.jpg',	9,	'admin123',	NULL,	NULL,	'123@gmail.com',	'$2y$10$aD8zzbjyp0MFx2wl.mxWjuYERbrNjPsi6hBOWyk9BkXnhl..d96gq',	1,	NULL,	'eGbKRmzsY3Icawq3yC1j2ZyIsNu8G0n8DH6IJMl50fP8ZZgpSfDQrprQD49N',	'2025-06-28 18:56:39',	'2025-06-29 05:54:29'),
...
(11,	NULL,	11,	'dada',	NULL,	NULL,	NULL,	'$2y$10$kIWZZFfB6ZbN1DRHmG1n3.VJvItNdfBm4cZo969sb1fgz4.IpHTEu',	0,	NULL,	NULL,	'2025-08-04 22:54:18',	'2025-08-04 22:54:18'),
(12,	NULL,	12,	'andri123',	'123',	'123',	'123456@gmail.com',	'$2y$10$xbWE1Rgjm8yQvrk2YwAx3./eNMD2ziwLVlsNrtZhXVTW8i9rrE1QK',	0,	NULL,	NULL,	'2025-08-08 05:32:51',	'2025-08-08 18:43:51');

-- 2025-08-09 07:42:37 UTC
